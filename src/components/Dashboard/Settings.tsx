      ...
      <div className="flex flex-col gap-3 justify-center items-center text-2xl">
        <section className="flex flex-col gap-3 w-full bg-[#AEAEAE] rounded-md p-5">
          <div className="flex gap-3 items-center">
            ...
            <p className="text-darkPrimary text-2xl">Link Account</p>
          </div>
          {user && (
            <AnimatedTooltip
              items={providers}
      ...
      {user && (
        <Dialog>
          <DialogTrigger asChild>
            <button
              className={`px-3 py-2 rounded-md bg-capuut text-white text-lg flex justify-center items-center gap-2 w-full`}
            >
              Delete Account
            </button>
          </DialogTrigger>
