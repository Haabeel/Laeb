  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-lightSecondary text-slate-50 hover:bg-lightSecondary hover:text-slate-50 focus:bg-lightSecondary focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        day_today:
